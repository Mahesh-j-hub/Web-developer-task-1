...
<header class="site-header">
    <div class="wrapper site-header__wrapper">
      <div class="site-header__start" style="color:cornsilk">
        Rudra Grameen Bank
      </div>
      <div class="site-header__middle">
        <nav class="nav">
          ...
          <ul class="nav__wrapper" style="color:black">
...
<footer class="footer">
   <p>&copy 2021  <b>Mahesh Jadhav</b> </br>Chairman, Rudra Grameen Bank <br> Swayay Samridhi Foundation</p>
</footer>
